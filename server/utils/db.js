...
mongoose.Query.prototype.maxTimeMS(60000); // Default 60 seconds for query execution
...
const connectDB = async () => {
  try {
    ...
    console.error(
      `MongoDB Connection Error (Attempt ${connectionRetries + 1}):`,
      error.message
    );
    ...
    if (connectionRetries < MAX_CONNECTION_RETRIES) {
      connectionRetries++;
      console.log(
        `Retrying connection in 5 seconds... (${connectionRetries}/${MAX_CONNECTION_RETRIES})`
      );
