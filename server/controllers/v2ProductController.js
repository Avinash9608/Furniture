...
exports.createProduct = async (req, res) => {
  try {
    ...
    console.log(
      ...
      JSON.stringify(product.toObject(), null, 2)
    );
...
exports.createTestProduct = async (req, res) => {
  try {
    ...
    if (!category) {
      ...
      await category.save();
      console.log("Test category created:", category._id);
    } else {
      console.log("Using existing test category:", category._id);
    }
    ...
    const product = new Product({
      name: productName,
      slug: uniqueSlug,
      description: "This is a test product with all fields populated",
      price: 999.99,
      discountPrice: 799.99,
      stock: 50,
      category: category._id,
      images: [
        "https://placehold.co/600x400/brown/white?text=Test+Product+1",
        "https://placehold.co/600x400/darkbrown/white?text=Test+Product+2",
      ],
      featured: true,
      dimensions: dimensions,
      material: "Solid Wood",
    ...
    console.log(JSON.stringify(savedProduct.toObject(), null, 2));
