/**
 * Test script to verify data is being fetched and displayed correctly after fixes
    ...
    try {
      ...
      if (response.data) {
        ...
        results.success.push({
          ...
          path: endpoint.path,
          count: count,
          data: Array.isArray(data) && data.length > 0 ? data.slice(0, 2) : []
        });
      } else {
...
${results.success.map(endpoint => `### ${endpoint.name}
\`\`\`json
