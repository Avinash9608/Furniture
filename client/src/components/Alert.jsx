        ...
        >
          ...
          <button
            ...
            className={`ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex h-8 w-8 ${
              type === 'info' ? 'bg-blue-100 text-blue-500 focus:ring-blue-400' :
              type === 'success' ? 'bg-green-100 text-green-500 focus:ring-green-400' :
              type === 'warning' ? 'bg-yellow-100 text-yellow-500 focus:ring-yellow-400' :
