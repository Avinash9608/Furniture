    ...
    <footer className="bg-secondary text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">Shyam Furnitures</h3>
            <p className="mb-4 text-gray-300">
              Quality furniture for your home and office in Sharsha, Bihar. We provide the best furniture solutions since 2010.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=sofas" className="text-gray-300 hover:text-white transition-colors duration-300">Sofas</Link>
              </li>
              <li>
                <Link to="/products?category=beds" className="text-gray-300 hover:text-white transition-colors duration-300">Beds</Link>
              </li>
              <li>
                <Link to="/products?category=tables" className="text-gray-300 hover:text-white transition-colors duration-300">Tables</Link>
              </li>
              <li>
                <Link to="/products?category=chairs" className="text-gray-300 hover:text-white transition-colors duration-300">Chairs</Link>
              </li>
              <li>
                <Link to="/products?category=wardrobes" className="text-gray-300 hover:text-white transition-colors duration-300">Wardrobes</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Main Road, Sharsha, Bihar, India</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@shyamfurnitures.com</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span className="text-gray-300">Mon-Sat: 9:00 AM - 8:00 PM</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-300">
          <p>&copy; {currentYear} Shyam Furnitures. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
