      ...
      {loadingSettings ? (
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-4">
          <p className="text-yellow-700">
            Payment settings are not configured. Please contact the administrator.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
            <h3 className="font-medium text-blue-800 mb-2">Payment Account Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-blue-700">
                  <span className="font-medium">Account Number:</span> {paymentSettings.accountNumber}
                </p>
                <p className="text-sm text-blue-700">
                  <span className="font-medium">IFSC Code:</span> {paymentSettings.ifscCode}
                </p>
              </div>
              <div>
                <p className="text-sm text-blue-700">
                  <span className="font-medium">Account Holder:</span> {paymentSettings.accountHolder}
                </p>
