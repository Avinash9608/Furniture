...
const Cart = () => {
  ...
  const handleApplyCoupon = (e) => {
    ...
    if (validCoupons[couponCode]) {
      const discountValue = typeof validCoupons[couponCode] === 'number' && validCoupons[couponCode] < 1
        ? totalPrice * validCoupons[couponCode]
        : validCoupons[couponCode];
      
      setDiscount(discountValue);
      setCouponSuccess(`Coupon applied successfully! You saved ${formatPrice(discountValue)}`);
    } else {
  ...
  return (
    <div className="bg-gray-50 py-8">
      <div className="container-custom">
        <h1 className="text-3xl font-serif font-bold mb-6">Your Shopping Cart</h1>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="text-center text-sm text-gray-500">
                  ...
                  <div className="flex justify-center space-x-2">
                    <span className="bg-gray-100 rounded px-2 py-1">Credit Card</span>
                    <span className="bg-gray-100 rounded px-2 py-1">PayPal</span>
                    <span className="bg-gray-100 rounded px-2 py-1">Cash on Delivery</span>
                  </div>
                </div>
              </div>
            </div>
