          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="theme-text-primary mb-4">
                Shyam Furnitures was founded in 2010 by Mr. Shyam Kumar in
                Sharsha, Bihar with a simple mission: to create beautiful,
                functional furniture that brings joy to homes and offices across
                India.
              </p>
              <p className="theme-text-primary mb-4">
                What started as a small workshop with just three craftsmen has
                now grown into a thriving business with over 50 skilled artisans
                and a 15,000 sq. ft. manufacturing facility. Despite our growth,
                we remain committed to our founding principles of quality
                craftsmanship, attention to detail, and customer satisfaction.
              </p>
              <p className="theme-text-primary">
                Each piece of furniture at Shyam Furnitures is crafted with
                care, combining traditional woodworking techniques with modern
                design sensibilities. We source the finest materials from
                sustainable suppliers to ensure that our products are not only
                beautiful but also environmentally responsible.
              </p>
            </motion.div>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            >
              ...
              <p className="theme-text-secondary max-w-2xl mx-auto">
                We're driven by our commitment to excellence and customer
                satisfaction
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              className="theme-bg-primary p-8 rounded-lg shadow-md"
            >
              ...
              <p className="theme-text-primary">
                To create beautiful, functional, and durable furniture that
                enhances the quality of life for our customers. We strive to
                combine traditional craftsmanship with innovative design to
                deliver products that exceed expectations in terms of quality,
            ...
            >
              ...
              <p className="theme-text-primary">
                To be recognized as the leading furniture brand in Bihar and
                beyond, known for our commitment to quality, innovation, and
                customer satisfaction. We aim to grow our business while
                maintaining our core values and contributing positively to our
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="theme-text-primary">
                We never compromise on quality. From material selection to the
                final product, we maintain the highest standards at every step
            ...
            >
              ...
              <p className="theme-text-primary">
                ...
                exceed expectations and build long-lasting relationships based
            ...
            >
              ...
              <p className="theme-text-primary">
                We are committed to environmentally responsible practices. We
                source materials from sustainable suppliers and minimize waste
      ...
      <section className="py-16">
        <div className="container-custom">
          ...
          >
            ...
            <p className="theme-text-secondary max-w-2xl mx-auto">
              Experience our furniture collection in person at our showroom in
              Sharsha, Bihar
            </p>
          </motion.div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-white/90 max-w-2xl mx-auto mb-8">
              Browse our collection and find the perfect furniture pieces for
              your home or office.
            </p>
            <Link
              to="/products"
              className="bg-white text-primary hover:bg-gray-100 font-medium py-3 px-6 rounded-md transition duration-300"
            >
